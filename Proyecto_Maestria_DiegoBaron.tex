...
\HRule \\[0.4cm]
{ \huge \bfseries Estudios de \textit{High Level Trigger} para la detección de materia oscura en modelos con fermiones vectoriales de espectro comprimido, usando el detector CMS en el LHC}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
Estudios de \textit{High Level Trigger} para la detección de materia oscura en modelos con fermiones vectoriales de espectro comprimido, usando el detector CMS en el LHC.
\\
